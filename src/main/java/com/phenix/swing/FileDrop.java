 ...
 * a Java program. Any <code>java.awt.Component</code> can be dropped onto, but
 * only <code>javax.swing.JComponent</code>s will indicate the drop event with a
 * changed border.
 * <p>
 * To use this class, construct a new <code>FileDrop</code> by passing it the
 * target component and a <code>Listener</code> to receive notification when
...
public class FileDrop {
     ...
     * targets. If your component is a <code>java.awt.Container</code>, then
     ...
     * <code>System.out</code> or <code>System.err</code>. A <code>null</code>
     * value for the parameter <code>out</code> will result in no debugging
     * output.
     *
     ...
     * <code>java.awt.Container</code>, then each of its children components
     ...
     *
     * @param c Component on which files will be dropped.
     * @param dragBorder Border to use on <code>JComponent</code> when dragging
     * occurs.
     * @param listener Listens for <code>filesDropped</code>.
     * @since 1.0
     */
     ...
     * drop targets. If your component is a <code>java.awt.Container</code>,
        ...
        try {
            ...
            while ((line = bReader.readLine()) != null) {
                try {
                    ...
                    log(out, "Error with " + line + ": " + exception.getMessage());
                }
            }
     ...
     * @return
     */
    public static boolean remove(java.io.PrintStream out, Component c, boolean recursive) {   // Make sure we support dnd.
        if (supportsDnD()) {
    ...
    /* ********  I N N E R   C L A S S  ******** */
    /**
     * This is the event that is passed to the {link
     * FileDropListener#filesDropped filesDropped(...)} method in your {link
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable {
         ...
         * {@link TransferableObject} has the representation class
         * <code>net.iharder.dnd.TransferableObject.class</code> and the MIME
         * type <code>application/x-net.iharder.dnd.TransferableObject</code>.
         *
         * @since 1.1
         */
         ...
         * default {@link #DATA_FLAVOR} associated with {link
         * TransferableObject}, and third the {link
        ...
        /**
         * Returns <code>true</code> if <var>flavor</var> is one of the
         * supported flavors. Flavors are supported using the
